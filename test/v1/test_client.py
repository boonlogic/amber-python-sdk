...
class Test_01_AmberInstance:
    ...
    def test_01_init(self):
        ...
        profile1 = AmberClient(license_file='test.Amber.license', license_id='garbage')

        # load the same profile using license loaded from environment
        os.environ['AMBER_LICENSE_FILE'] = 'test.Amber.license'
        profile2 = AmberClient(license_id='garbage')
        ...
        profile3 = AmberClient(license_file='test.Amber.license', license_id='garbage')
        ...
        os.environ['AMBER_SSL_CERT'] = "bogus_ssl_cert"
        os.environ['AMBER_SSL_VERIFY'] = "false"
        profile4 = AmberClient(license_file='bogus.Amber.license', license_id='garbage')
